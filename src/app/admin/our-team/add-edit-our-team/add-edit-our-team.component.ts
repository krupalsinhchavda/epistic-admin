...
@Component({
  selector: 'app-add-edit-our-team',
  templateUrl: './add-edit-our-team.component.html',
  styleUrls: ['./add-edit-our-team.component.css']
})
export class AddEditOurTeamComponent implements OnInit {
